        ...
        <div class="col-md-12">
					...
					<div class="box box-danger">
						<div class="box-header">
							<a href="#tambahkategori" data-toggle="modal" class="btn btn-success">Tambah</a>
						</div>
						<!-- /.box-header -->
			          ...
			          <table class="table table-hover table-bordered">
			            ...
			            <tr>
			              ...
			              <td class="text-center">
											<a href="#editkategori{{ $categories->id }}" data-toggle="modal" class="btn btn-success btn-xs"><span class="fa fa-edit"></span></a>
											<a href="#hapuskategori{{ $categories->id }}" data-toggle="modal" class="btn btn-danger btn-xs"><span class="fa fa-trash"></span></a>
										</td>
			            </tr>
									@endforeach
			          </table>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">Edit Kategorii</h4>
						</div>
						<div class="modal-body">
							<!-- Horizontal Form -->
								<!-- form start -->
								<form role="form" method="POST" action="/admin-kategori">
									{{ csrf_field() }}
									<div class="box-body">
			...
			<div class="modal fade" id="editkategori{{ $edit->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						...
						<div class="modal-body">
							<!-- Horizontal Form -->
								<!-- form start -->
								<form role="form" method="POST" action="/admin-kategori/{{ $edit->id }}">
									{{ method_field('PUT') }}
									{{ csrf_field() }}
									<div class="box-body">
										<div class="form-group{{ $errors->has('kategori') ? ' has-error' : '' }}">
											<label>Nama Kategori</label>
											<input type="text" class="form-control" name="kategori" placeholder="Nama kategori" value="{{ $edit->nama }}">
										</div>
			...
			@foreach ($kategori as $hapus)
        <div class="modal modal-danger fade" id="hapuskategori{{ $hapus->id }}" >
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <div class="modal-footer">
								...
								<form action="admin-kategori/{{ $hapus->id }}" method="post">
									{{ method_field('DELETE') }}
									{{ csrf_field() }}
